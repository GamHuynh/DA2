...
<body id="page-top">
<?php require_once 'Them_TK_SV.php' ?>
    <div id="wrapper">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="DanhSachSV.php" >Danh sách sinh viên</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="TaiKhoanSV.php">Đăng xuất</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <tr>
            ...
            <!-- Truy vấn bảng giảng viên -->
                ...
                $conn = mysqli_connect("localhost", "root", "", "dbdoan2") or die("Không thể kết nối CSDL");
                 $STT = 1;
                 $result = $conn->query("SELECT TenTaiKhoan, MatKhau, VaiTro FROM taikhoan Where VaiTro = 'sinhvien'");
                //  Bắt đầu vòng lặp
                ...
                <tbody id = "myTable" style = "text-align: center;">
                    ...
                    <tr>
                      ...
                      <a href="TaiKhoanSV.php?sua=<?php echo $row['TenTaiKhoan'];?>" class="btn btn-info"> Sửa </a> 
                      <a class='btn btn-danger btn-sm' href="XoaGV.php?Xoa=<?php echo $row['TenTaiKhoan']; ?>"> <i class='fas fa-trash'> </i>Xóa </a>
    ...
    <!-- <a href="./ThemGV.html"><input type="button" value="Thêm Giảng Viên"  style="margin-left: 500px;"/></a> -->
         ...
         <!-- NÚT THÊM GIẢNG VIÊN -->
                 ...
                 <a class="collapse-item"  style="padding-left: 550px;">Thêm Tài Khoản Sinh Viên</a>
            <form class="user" method="POST" action ="Them_TK_SV.php">
                <div class="form-group row">
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-user" 
                        placeholder="Tên tài khoản" name="TenTaiKhoan" style="margin-left: 100px;" value="<?php echo $TenTaiKhoan;?>"> 
                    </div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-user"
                            placeholder="Mật Khẩu" name="MatKhau" style="margin-left: 100px" value="<?php echo $MatKhau;?>">
                    </div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-user"
                            placeholder="Vai Trò" name="VaiTro" style="margin-left: 100px" value="<?php echo $VaiTro;?>" >
                    </div>
                </div>
                    <div>
                        <?php
                        if ($Sua == true):
                        ?>
                            <input type="submit" value="Sửa" name="sua" style="margin-left: 600px;">
                            <?php else : ?>
